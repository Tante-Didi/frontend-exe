...
// What will be the output? //it will work ,
// because even if you can call the function before you declare function declaration,it is hoisted to the top of the scope and it will work
function myFuncDecl() {
  return;
